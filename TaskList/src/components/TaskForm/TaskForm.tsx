...
const TaskForm: React.FC = () => {
  //state used to track the form fields
  const [title, setTitle] = useState('');
  const [description, setDescription] = useState('');
  //useTasks is the hook to get the createTask function and the loading state
  const { createTask, loading } = useTasks();
  //createTask is the function to create a task
  //loading is the state to track if the task is being created
